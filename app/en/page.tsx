  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="sticky top-0 z-40 bg-slate-950/95 backdrop-blur border-b border-white/5">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="text-xs text-slate-500 hover:text-slate-300 transition-colors border border-white/10 px-2 py-1 rounded-md">PL</Link>
          </div>
          <Link
            href="/zamow"
      ...
      <section className="relative bg-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight leading-[1.08] text-white mb-6 animate-fade-up">
            ...
            <span className="text-indigo-400">Write a letter they<br className="hidden sm:block" /> must respond to.</span>
          </h1>
          ...
          <p className="text-base sm:text-lg text-slate-400 max-w-xl mx-auto mb-10 leading-relaxed animate-fade-up delay-100">
            ...
            Ready in 5 minutes. The store has <strong className="text-white font-semibold">14 days</strong> to respond —
          ...
          <div className="animate-fade-up delay-200">
            ...
            <div className="flex items-center justify-center gap-3 mt-5">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-slate-400 mt-0.5">&ldquo;Got a full PLN 1,240 refund in 8 days&rdquo; — Marcin K.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-slate-950">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-indigo-400 text-xs font-bold uppercase tracking-widest mb-3">Why it works</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">
              Stores ignore generic complaints.<br className="hidden sm:block" /> They won&apos;t ignore yours.
            </h2>
            <p className="text-slate-400 text-sm">Specific law articles change everything</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {PROBLEMS.map((item, i) => (
              <div key={i} className="bg-slate-900 rounded-2xl border border-white/5 p-5 space-y-4 hover:border-white/10 transition-all">
      ...
      <section className="bg-slate-950 py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-xl mx-auto">
          <p className="text-indigo-400 text-xs font-bold uppercase tracking-widest mb-4">Do it now</p>
          ...
          <p className="text-slate-500 text-sm mt-4">Free appeal if it doesn&apos;t work</p>
        </div>
      </section>
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-8 px-6 text-center text-xs text-slate-500">
        ...
        <p className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <a href="mailto:hello@writeback.pl" className="hover:text-slate-300 transition-colors">hello@writeback.pl</a>
          <span>·</span>
          <Link href="/regulamin" className="hover:text-slate-300 transition-colors">Terms of Service</Link>
          <span>·</span>
          <Link href="/polityka" className="hover:text-slate-300 transition-colors">Privacy Policy</Link>
          <span>·</span>
          <Link href="/" className="hover:text-slate-300 transition-colors">🇵🇱 Polski</Link>
          <span>·</span>
