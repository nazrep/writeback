...
export default function Content() {
  return (
    <>
      ...
      <h3>„Reklamacja dotyczy uszkodzeń mechanicznych"</h3>
      <p>„Uszkodzenie mechaniczne" to termin, który sklepy nadużywają. Sama fotografia zarysu albo wgniecenia nie dowodzi że to Ty uszkodziłeś produkt — a już na pewno nie automatycznie. Zażądaj szczegółowej opinii technicznej wskazującej konkretną przyczynę uszkodzenia i jej związek z Twoim działaniem.</p>

      <h3>„Produkt nosi ślady użytkowania"</h3>
      <p>Oczywiście, że nosi — bo go używałeś. Ślady normalnego użytkowania nie są podstawą do odmowy reklamacji. Sklep musi wykazać, że konkretna wada (nie ogólne ślady użycia) powstała wskutek działania niezgodnego z instrukcją obsługi.</p>

      <h2>Jak napisać skuteczne odwołanie od odmowy reklamacji</h2>
      ...
      <p>Ten ostatni punkt działa skutecznie — sklep, który wie że sprawa trafi do UOKiK, często ustępuje zanim dojdzie do eskalacji.</p>

      <h2>Co jeśli odwołanie też nie pomoże?</h2>
      <p>Jeśli sklep nadal odmawia po formalnym odwołaniu, masz kilka ścieżek:</p>
      <ul>
        ...
        <li><strong>Sąd rejonowy</strong> — obsługuje sprawy do 100 000 zł; roszczenia do 20 000 zł rozpatrywane są w trybie uproszczonym (art. 505¹ KPC), co obniża koszty. Koszty sądowe przy wygranej pokrywa sklep.</li>
      </ul>
      ...
      <h2>Ile masz czasu na odwołanie?</h2>
      <p>Przepisy nie przewidują formalnego terminu na odwołanie od odmowy reklamacji — liczy się tylko 2-letni termin odpowiedzialności sprzedawcy od daty dostarczenia towaru. Mimo to nie warto zwlekać: im szybciej wyślesz odwołanie, tym świeższa jest dokumentacja i tym trudniej sklepowi kwestionować szczegóły.</p>

      <h2>Praktyczny przykład: okleina odchodząca od drzwi</h2>
      ...
      <h2>Jak writeback.pl może pomóc</h2>
      <p>Jeśli Twoja reklamacja została odrzucona — możemy napisać za Ciebie formalne odwołanie z pełną podstawą prawną. Opisujesz sytuację, my generujemy gotowe pismo PDF, które możesz wysłać do sklepu lub do UOKiK.</p>
      <p>Pismo zawiera powołanie na właściwe artykuły ustawy, konkretne żądanie z terminem i informację o dalszych krokach prawnych. Sklepy traktują takie pisma poważnie — bo widzą, że konsument zna przepisy i jest zdecydowany działać.</p>

      <div style={{ margin: "2rem 0", padding: "1.5rem", background: "#eef2ff", borderRadius: "12px", border: "1px solid #c7d2fe" }}>
        <p style={{ margin: 0, fontWeight: 600, color: "#3730a3", marginBottom: "0.5rem" }}>Reklamacja odrzucona? Napisz odwołanie w 5 minut.</p>
        <p style={{ margin: 0, color: "#4338ca", fontSize: "0.9rem" }}>Opisz sytuację → generujemy pismo z podstawą prawną → wysyłasz do sklepu. 29 zł, PDF na maila od razu.</p>
      </div>
    </>
  );
}
