  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Sąd powszechny</strong>: przy kwotach powyżej kilku tysięcy złotych warto to rozważyć. Przy wartości sporu do 20 tys. złotych postępowanie uproszczone jest relatywnie tanie (art. 505¹ KPC)</li>
      </ul>
