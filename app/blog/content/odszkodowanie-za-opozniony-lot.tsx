...
export default function Content() {
  return (
    <>
      ...
      <p><strong>Kluczowy wyrok TSUE C-549/07 (<em>Wallentin-Hermann v. Alitalia</em>)</strong>: <strong>awaria techniczna samolotu NIE stanowi nadzwyczajnej okoliczności</strong>, chyba że wynika ze zdarzenia zewnętrznego wobec normalnej działalności linii (np. ukrytej wady fabrycznej wykrytej przez producenta). Regularne usterki techniczne to ryzyko wchodzące w zakres normalnej działalności przewoźnika.</p>
