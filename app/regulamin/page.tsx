        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-8">
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>Niniejszy Regulamin określa zasady świadczenia usług drogą elektroniczną przez Macieja Perzankowskiego, prowadzącego działalność gospodarczą pod nazwą <strong>Maciej Perzankowski</strong>, ul. [adres], [kod] Skierniewice, NIP: 8361881457, REGON: 523814249 (dalej: „Usługodawca").</li>
