    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-gray-100">
      <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center rounded-lg border border-gray-200 text-xs font-semibold overflow-hidden">
            <span className="w-9 text-center py-1.5 bg-indigo-600 text-white">PL</span>
            <Link href="/en" className="w-9 text-center py-1.5 text-gray-400 hover:text-gray-700 transition-colors border-l border-gray-200">EN</Link>
          </div>
          <Link
            href="/zamow"
